...
function Listings() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-5 w-full max-w-9xl mx-auto">
      <h2 className="mb-7 font-extrabold text-3xl text-black-900 md:text-5xl">
          ...
          >
            <div class="shadow p-4 rounded-lg bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
              ...
              <div class="mt-4">
                ...
                >
                  929 F. R. Hidalgo Street, Barangay 393
                </p>
              </div>
              ...
              <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8 mb-6">
                ...
                <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  ...
                  <span class="mt-2 xl:mt-0">13 sq m</span>
                </p>
              </div>
              ...
              <div class="flex justify-end">
                <p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                  ...
                  <span class="text-lg">7,500</span>/m
                </p>
              </div>
            </div>
          </a>
      ...
      <div className="flex float-right mt-8">
        <a
          href="#_"
          class="relative inline-flex items-center justify-center mr-4 p-4 px-6 py-3 overflow-hidden font-medium text-gray-600 transition duration-300 ease-out border-2 border-gray-600 rounded-full shadow-md group"
        >
          <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 translate-x-full bg-gray-700 group-hover:translate-x-0 ease">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <span class="absolute flex items-center justify-center w-full h-full text-gray-600 transition-all duration-300 transform group-hover:translate-x-full ease">
            Previous
          </span>
        ...
        <a
          href="#_"
          class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-gray-600 transition duration-300 ease-out border-2 border-gray-600 rounded-full shadow-md group"
        >
          <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-gray-700 group-hover:translate-x-0 ease">
            <svg
              class="w-6 h-6"
